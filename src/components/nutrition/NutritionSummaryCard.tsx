    ...
    <div className="bg-gradient-to-br from-[#ff9f43] to-[#ffb76b] rounded-3xl p-4 text-[#5D4037] space-y-3">
      ...
      <div>
        <Progress 
          ...
          className="h-2 bg-[#5D4037]/20"
          indicatorClassName="bg-[#5D4037]/70"
        />
        <p className="text-xs text-[#5D4037]/80 mt-1.5 flex items-center gap-1">
      ...
      <div className="grid grid-cols-3 gap-2">
        {/* 탄수화물 */}
        <div className="bg-[#5D4037]/10 rounded-lg p-2">
          <div className="flex items-center gap-1 mb-0.5">
            <Wheat className="w-3 h-3 shrink-0" />
            <span className="text-[10px] whitespace-nowrap">탄수화물</span>
          </div>
          <Progress value={carbPercent} className="h-1 bg-[#5D4037]/20 mb-0.5" indicatorClassName="bg-[#5D4037]/70" />
        ...
        <div className="bg-[#5D4037]/10 rounded-lg p-2">
          ...
          <Progress value={proteinPercent} className="h-1 bg-[#5D4037]/20 mb-0.5" indicatorClassName="bg-[#5D4037]/70" />
        ...
        <div className="bg-[#5D4037]/10 rounded-lg p-2">
          ...
          <Progress value={fatPercent} className="h-1 bg-[#5D4037]/20 mb-0.5" indicatorClassName="bg-[#5D4037]/70" />
