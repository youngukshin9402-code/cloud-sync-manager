  ...
  return <header className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-border/50">
      <div className="container mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <a href="#yanggaengs" className="text-lg text-muted-foreground hover:text-foreground transition-colors">
            3가지 양갱
          </a>
          <a href="#benefits" className="text-lg text-muted-foreground hover:text-foreground transition-colors">
            특징
          </a>
        </nav>
